...
class CheckinStatusCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final checkinAsync = ref.watch(todayCoupleCheckinProvider);

    return checkinAsync.when(
      data: (checkin) {
        if (checkin == null) {
          // Pas encore fait aujourd'hui
          return _buildNotDoneCard(context);
        } else {
          // Déjà fait
          return _buildDoneCard(context, checkin);
        }
      },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // CARD : PAS ENCORE FAIT
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  Widget _buildNotDoneCard(BuildContext context) {
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Prends 5 minutes pour ta relation',
                      style: TextStyle(
                        fontSize: 14,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () => context.go('/couple-checkin'),
  ...
  Widget _buildDoneCard(BuildContext context, dynamic checkin) {
    final cs = Theme.of(context).colorScheme;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Tu as fait ton check-in aujourd\'hui 🎉',
  ...
  Widget _buildMiniScore(BuildContext context, String emoji, String label, int score) {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
