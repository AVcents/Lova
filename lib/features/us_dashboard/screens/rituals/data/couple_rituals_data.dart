...
class CoupleRitualsData {
  ...
  static final List<CoupleRitual> predefinedRituals = [
    ...
    const CoupleRitual(
      ...
      instructions: 'Créez une ambiance calme avec lumière tamisée. Utilisez de l\'huile de massage. Alternez qui donne et qui reçoit. Communiquez sur la pression et les zones préférées.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Enlacez-vous confortablement, respirez ensemble, fermez les yeux. Restez présents sans parler. Sentez le corps de l\'autre contre le vôtre.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Créez une atmosphère romantique. Prenez le temps des préliminaires. Communiquez vos envies. Soyez présents l\'un à l\'autre.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Installez-vous confortablement, face à face. Éteignez les téléphones. Posez des questions ouvertes, écoutez vraiment sans juger.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Tour à tour, partagez 3 choses pour lesquelles vous êtes reconnaissants aujourd\'hui : une pour vous, une pour l\'autre, une pour votre couple.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Regardez votre partenaire dans les yeux. Dites-lui ce que vous aimez chez lui/elle, ce qui vous a touché récemment, pourquoi vous l\'aimez.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Préparez des amuse-gueules et vos boissons préférées. Installez-vous confortablement. Rangez les téléphones. Discutez, rigolez, profitez.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Choisissez une recette ensemble. Répartissez les tâches. Mettez de la musique. Goûtez en cours de route. Amusez-vous !',
    ...
    const CoupleRitual(
      ...
      instructions: 'Sortez dehors, dans un parc ou votre quartier. Marchez à un rythme confortable, main dans la main. Discutez ou profitez du silence ensemble.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Mettez votre playlist préférée. Dansez collés ou séparés. Peu importe le style, amusez-vous ! Rigolez ensemble.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Asseyez-vous confortablement côte à côte ou face à face. Fermez les yeux. Respirez ensemble. Suivez une méditation guidée ou restez en silence.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Trouvez un espace dégagé. Faites des étirements doux ensemble, en vous aidant mutuellement. Respirez profondément.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Installez-vous confortablement. Lisez le même livre chacun de votre côté ou lisez à voix haute l\'un pour l\'autre.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Utilisez le jeu LOOVA Intimité ou créez vos propres questions. Répondez tour à tour avec honnêteté et bienveillance.',
    ...
    const CoupleRitual(
      ...
      instructions: 'Inventez des scénarios absurdes, faites des imitations, créez des personnages. L\'objectif : rire ensemble !',
