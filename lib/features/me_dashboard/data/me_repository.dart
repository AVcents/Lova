// lib/features/me_dashboard/data/me_repository.dart
...
class MeRepository {
  ...
  Future<MeCheckin?> createCheckin({
    required int mood,
    String? trigger,
    String? note,
  }) async {
    ...
    try {
      ...
      return MeCheckin.fromJson(response);
    } catch (e) {
  ...
  Future<MeCheckin?> getTodayCheckin() async {
    ...
    try {
      ...
      return MeCheckin.fromJson(response.first);
    } catch (e) {
  ...
  Future<List<MeCheckin>> getCheckinsHistory({int days = 30}) async {
  ...
  Future<MeStreak?> getStreak() async {
    if (_currentUserId == null) return null;
    ...
    try {
      ...
      return MeStreak.fromJson(response);
    } catch (e) {
  ...
  Stream<MeStreak?> watchStreak() {
    ...
    return _supabase
      ...
      return MeStreak.fromJson(userStreak.first);
    });
  }
  ...
  Future<MeMetrics?> getCurrentWeekMetrics() async {
    if (_currentUserId == null) return null;
    ...
    try {
      ...
      return MeMetrics.fromJson(response);
    } catch (e) {
  ...
  Stream<MeMetrics?> watchCurrentWeekMetrics() {
    if (_currentUserId == null) {
      return Stream.value(null);
    }
    ...
    return _supabase
      ...
      return MeMetrics.fromJson(userMetrics.first);
    });
  }
