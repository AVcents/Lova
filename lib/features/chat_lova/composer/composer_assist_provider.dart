...
import 'composer_assist_repository.dart';
...
class ComposerAssistParams {
  ...
  String get toneLabel {
    switch (tone) {
      case 0: return 'Chaleureux';
      case 1: return 'Neutre';
      case 2: return 'Assertif';
  ...
  String get profileChip => '$toneLabel • $lengthLabel • Empathie ${empathyLabel.toLowerCase()}';
}
...
final composerAssistProvider = StateNotifierProvider<ComposerAssistNotifier, ComposerAssistState>((ref) {
...
class ComposerAssistNotifier extends StateNotifier<ComposerAssistState> {
  ...
  Future<void> generateVariations(List<String> history, String contextText) async {
