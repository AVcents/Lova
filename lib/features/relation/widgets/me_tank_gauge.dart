...
class MeTankGauge extends ConsumerStatefulWidget {
  final int value;
  ...
  MeTier get tier {
    ...
    if (value <= 74) return MeTier.mid;
    return MeTier.high;
  }

  @override
  ConsumerState<MeTankGauge> createState() => _MeTankGaugeState();
}

class _MeTankGaugeState extends ConsumerState<MeTankGauge>
  ...
  MeTier _previousTier = MeTier.low;
  ...
  @override
  void didUpdateWidget(MeTankGauge oldWidget) {
...
class _MeTankPainter extends CustomPainter {
...
/// Bottom sheet pour les rituels rapides Me Tank
void showMeTankRitualsSheet(BuildContext context, WidgetRef ref) {
...
class _MeTankRitualsSheet extends ConsumerWidget {
  const _MeTankRitualsSheet();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final rituals = [
      ...
      const _RitualAction(
        ...
        points: '+4',
        action: MeTankAction.journalGratitude,
      ),
    ];
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () async {
            ...
            // Si c'est le journal, ouvrir un dialog spécial
            ...
            if (context.mounted) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('${ritual.title} ${ritual.points}'),
  ...
  Future<bool?> _showJournalDialog(BuildContext context) {
