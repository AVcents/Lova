...
import 'package:lova/features/profile/data/profile_repository.dart';
...
final todayCheckinProvider = FutureProvider<ProfileCheckin?>((ref) async {
...
StateNotifierProvider<CheckinNotifier, AsyncValue<ProfileCheckin?>>((ref) {
  return CheckinNotifier(ref.watch(profileRepositoryProvider));
});

class CheckinNotifier extends StateNotifier<AsyncValue<ProfileCheckin?>> {
...
FutureProvider.family<List<ProfileCheckin>, int>((ref, days) async {
  final repository = ref.watch(profileRepositoryProvider);
...
final streakProvider = StreamProvider<ProfileStreak?>((ref) {
  final repository = ref.watch(profileRepositoryProvider);
  return repository.watchStreak();
});

/// Provider pour récupérer le streak une seule fois
final currentStreakProvider = FutureProvider<ProfileStreak?>((ref) async {
  final repository = ref.watch(profileRepositoryProvider);
...
final weekMetricsProvider = StreamProvider<ProfileMetrics?>((ref) {
  final repository = ref.watch(profileRepositoryProvider);
  return repository.watchCurrentWeekMetrics();
});

/// Provider pour récupérer les métriques une seule fois
final currentWeekMetricsProvider = FutureProvider<ProfileMetrics?>((ref) async {
  final repository = ref.watch(profileRepositoryProvider);
...
StateNotifierProvider<ActionsNotifier, AsyncValue<void>>((ref) {
  return ActionsNotifier(ref.watch(profileRepositoryProvider));
});
...
StateNotifierProvider<JournalNotifier, AsyncValue<void>>((ref) {
  return JournalNotifier(ref.watch(profileRepositoryProvider));
});
